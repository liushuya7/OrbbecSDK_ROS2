...
class ImageSyncNode : public rclcpp::Node {
 public:
  ImageSyncNode(const double hz)
    ...
    camera_01_color_sub_.subscribe(this, "/camera_01/color/image_raw", qos);
    camera_01_depth_sub_.subscribe(this, "/camera_01/depth/image_raw", qos);
    camera_02_color_sub_.subscribe(this, "/camera_02/color/image_raw", qos);
    camera_02_depth_sub_.subscribe(this, "/camera_02/depth/image_raw", qos);
    camera_03_color_sub_.subscribe(this, "/camera_03/color/image_raw", qos);
    camera_03_depth_sub_.subscribe(this, "/camera_03/depth/image_raw", qos);
    camera_04_color_sub_.subscribe(this, "/camera_04/color/image_raw", qos);
    camera_04_depth_sub_.subscribe(this, "/camera_04/depth/image_raw", qos);
